...
public class RebalanceListenersExample {
  ...
  public static void main(String[] args) {
    ...
    try {
      consumer.subscribe(
          Collections.singletonList("CustomerCountry"),
          new HandleRebalance(consumer, currentOffsets));
      while (true) {
  ...
  private static class HandleRebalance implements ConsumerRebalanceListener {
    ...
    public HandleRebalance(
        Consumer<String, String> consumer, Map<TopicPartition, OffsetAndMetadata> currentOffsets) {
