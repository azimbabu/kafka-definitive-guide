...
public class SerializeDeserializeDemo {
  ...
  public static void main(String[] args) {
      ...
      AvroHttpRequest httpRequest = AvroHttpRequest.newBuilder()
    ...
    public byte[] serializeHttpRequest(AvroHttpRequest httpRequest) {
        ...
        try {
            Encoder jsonEncoder = EncoderFactory.get().jsonEncoder(AvroHttpRequest.getClassSchema(), stream);
    ...
    public AvroHttpRequest deserializeHttpRequest(byte[] data) {
        ...
        try {
            Decoder decoder = DecoderFactory.get().jsonDecoder(AvroHttpRequest.getClassSchema(), new String(data));
