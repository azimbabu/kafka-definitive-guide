...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"namespace\":\"baeldung.avro\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}");
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static baeldung.avro.ClientIdentifier.Builder newBuilder(baeldung.avro.ClientIdentifier.Builder other) {
    if (other == null) {
      return new baeldung.avro.ClientIdentifier.Builder();
    } else {
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static baeldung.avro.ClientIdentifier.Builder newBuilder(baeldung.avro.ClientIdentifier other) {
    if (other == null) {
      return new baeldung.avro.ClientIdentifier.Builder();
    } else {
      return new baeldung.avro.ClientIdentifier.Builder(other);
