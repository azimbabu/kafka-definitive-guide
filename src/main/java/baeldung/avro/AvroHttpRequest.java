...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase
  ...
  private static final org.apache.avro.io.DatumWriter<AvroHttpRequest> WRITER$ =
      (org.apache.avro.io.DatumWriter<AvroHttpRequest>) MODEL$.createDatumWriter(SCHEMA$);
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvroHttpRequest> READER$ =
      (org.apache.avro.io.DatumReader<AvroHttpRequest>) MODEL$.createDatumReader(SCHEMA$);
  private long requestTime;
  private baeldung.avro.ClientIdentifier clientIdentifier;
  private java.util.List<java.lang.CharSequence> employeeNames;
  private baeldung.avro.Active active;
   ...
   */
  public AvroHttpRequest(
      java.lang.Long requestTime,
      baeldung.avro.ClientIdentifier clientIdentifier,
      java.util.List<java.lang.CharSequence> employeeNames,
      baeldung.avro.Active active) {
   ...
   *     this class
   */
  public static AvroHttpRequest fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
   ...
   */
  public static baeldung.avro.AvroHttpRequest.Builder newBuilder() {
    return new baeldung.avro.AvroHttpRequest.Builder();
  }
   ...
   */
  public static baeldung.avro.AvroHttpRequest.Builder newBuilder(
      baeldung.avro.AvroHttpRequest.Builder other) {
    if (other == null) {
      return new baeldung.avro.AvroHttpRequest.Builder();
    } else {
      return new baeldung.avro.AvroHttpRequest.Builder(other);
    }
  }
   ...
   */
  public static baeldung.avro.AvroHttpRequest.Builder newBuilder(
      baeldung.avro.AvroHttpRequest other) {
    if (other == null) {
      return new baeldung.avro.AvroHttpRequest.Builder();
    } else {
      return new baeldung.avro.AvroHttpRequest.Builder(other);
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      case 0:
        ...
        break;
      case 1:
        clientIdentifier = (baeldung.avro.ClientIdentifier) value$;
        break;
      case 2:
        employeeNames = (java.util.List<java.lang.CharSequence>) value$;
        break;
      case 3:
        active = (baeldung.avro.Active) value$;
        break;
      default:
        throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
   ...
   */
  public baeldung.avro.ClientIdentifier getClientIdentifier() {
    return clientIdentifier;
  }
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(baeldung.avro.ClientIdentifier value) {
   ...
   */
  public baeldung.avro.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(baeldung.avro.Active value) {
    this.active = value;
  }
  ...
  public void customDecode(org.apache.avro.io.ResolvingDecoder in) throws java.io.IOException {
    ...
    if (fieldOrder == null) {
      ...
      if (this.clientIdentifier == null) {
        this.clientIdentifier = new baeldung.avro.ClientIdentifier();
      }
      ...
      if (a0 == null) {
        a0 =
            new SpecificData.Array<java.lang.CharSequence>(
                (int) size0, SCHEMA$.getField("employeeNames").schema());
      ...
      this.active = baeldung.avro.Active.values()[in.readEnum()];
  ...
  public static class Builder
      extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
      implements org.apache.avro.data.RecordBuilder<AvroHttpRequest> {

    private long requestTime;
    private baeldung.avro.ClientIdentifier clientIdentifier;
    private baeldung.avro.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private baeldung.avro.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(baeldung.avro.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder =
            baeldung.avro.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(baeldung.avro.AvroHttpRequest other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder setRequestTime(long value) {
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder clearRequestTime() {
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder setClientIdentifier(
        baeldung.avro.ClientIdentifier value) {
    ...
    /**
     * Gets the Builder instance for the 'clientIdentifier' field and creates one if it doesn't
     * exist yet.
     *
     * @return This builder.
     */
    public baeldung.avro.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(baeldung.avro.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(baeldung.avro.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder setClientIdentifierBuilder(
        baeldung.avro.ClientIdentifier.Builder value) {
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder clearClientIdentifier() {
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder setEmployeeNames(
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder setActive(baeldung.avro.Active value) {
     ...
     * @return This builder.
     */
    public baeldung.avro.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        record.requestTime =
            fieldSetFlags()[0] ? this.requestTime : (java.lang.Long) defaultValue(fields()[0]);
        if (clientIdentifierBuilder != null) {
          try {
          ...
          record.clientIdentifier =
              fieldSetFlags()[1]
                  ...
                  : (baeldung.avro.ClientIdentifier) defaultValue(fields()[1]);
        }
        ...
        record.active =
            fieldSetFlags()[3] ? this.active : (baeldung.avro.Active) defaultValue(fields()[3]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
