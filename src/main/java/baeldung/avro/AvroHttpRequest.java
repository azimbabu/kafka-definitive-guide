...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, baeldung.avro.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, baeldung.avro.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (baeldung.avro.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (baeldung.avro.Active)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static baeldung.avro.AvroHttpRequest.Builder newBuilder(baeldung.avro.AvroHttpRequest.Builder other) {
    if (other == null) {
      return new baeldung.avro.AvroHttpRequest.Builder();
    } else {
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static baeldung.avro.AvroHttpRequest.Builder newBuilder(baeldung.avro.AvroHttpRequest other) {
    if (other == null) {
      return new baeldung.avro.AvroHttpRequest.Builder();
    } else {
      return new baeldung.avro.AvroHttpRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private Builder(baeldung.avro.AvroHttpRequest.Builder other) {
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = baeldung.avro.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public baeldung.avro.AvroHttpRequest.Builder setClientIdentifier(baeldung.avro.ClientIdentifier value) {
    ...
    public baeldung.avro.AvroHttpRequest.Builder setClientIdentifierBuilder(baeldung.avro.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public baeldung.avro.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (baeldung.avro.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (baeldung.avro.Active) defaultValue(fields()[3]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
